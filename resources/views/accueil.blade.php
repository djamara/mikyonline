...
<head>
   ...
   <link href="http://localhost:8000/assets/css/font-awesome.min.css" rel="stylesheet" type="text/css">
...
<body>
       ...
       <ol class="carousel-indicators">
            ...
            <div class="carousel-inner">
                ...
                <div class="item">
                    ...
                    <img src="{{ asset('assets/img/backgrounds/header-bg-two.jpg') }}" alt="slider-image"/>
                </div>
                    <!-- Controls -->
                ...
                <div class="carousel-inner team-wrapper">
                    <div class="item active">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4 team-member">
                            <img src="{{ asset('assets/img/team/david.png') }}" alt="team-member-img1">
                        </div>
                    ...
                    <div class="item">
                        <!-- Team Member Two -->
                        <div class="col-xs-12 col-sm-4 col-md-4 team-member">
                            <img src="{{ asset('assets/img/team/jenna.png') }}" alt="team-member-img1">
                        </div>
                        <div class="col-xs-12 col-sm-8 col-md-8 team-member-bio">
                    ...
                    <div class="item">
                        <!-- Team Member Three -->
                        <div class="col-xs-12 col-sm-4 col-md-4 team-member">
                            <img src="{{ asset('assets/img/team/nicole.png') }}" alt="team-member-img1">
                        </div>
                        <div class="col-xs-12 col-sm-8 col-md-8 team-member-bio">
                    ...
                    <div class="portfolio-item">
                        <div class="hover-bg">
                            <a href="#portfolioModal1" class="portfolio-link" data-toggle="modal">
                                ...
                                <img src="{{ asset('assets/img/portfolio/card.jpg') }}" class="img-responsive" alt="portfolio-image">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="portfolio-item">
                        <div class="hover-bg">
                            <a href="#portfolioModal2" class="portfolio-link" data-toggle="modal">
                                ...
                                <img src="{{ asset('assets/img/portfolio/2.jpg') }}" class="img-responsive" alt="portfolio-image">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="portfolio-item">
                        <div class="hover-bg">
                            <a href="#portfolioModal1" class="portfolio-link" data-toggle="modal">
                                ...
                                <img src="{{ asset('assets/img/portfolio/3.jpg') }}" class="img-responsive" alt="portfolio-image">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="portfolio-item">
                        <div class="hover-bg">
                            <a href="#portfolioModal2" class="portfolio-link" data-toggle="modal">
                                ...
                                <img src="{{ asset('assets/img/portfolio/4.jpg') }}" class="img-responsive" alt="portfolio-image">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="portfolio-item">
                        <div class="hover-bg">
                            <a href="#portfolioModal1" class="portfolio-link" data-toggle="modal">
                                ...
                                <img src="{{ asset('assets/img/portfolio/5.jpg') }}" class="img-responsive" alt="portfolio-image">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="portfolio-item">
                        <div class="hover-bg">
                            <a href="#portfolioModal2" class="portfolio-link" data-toggle="modal">
                                ...
                                <img src="{{ asset('assets/img/portfolio/6.jpg') }}" class="img-responsive" alt="portfolio-image">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="portfolio-item">
                        <div class="hover-bg">
                            <a href="#portfolioModal1" class="portfolio-link" data-toggle="modal">
                                ...
                                <img src="{{ asset('assets/img/portfolio/1.jpg') }}" class="img-responsive" alt="portfolio-image">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="portfolio-item">
                        <div class="hover-bg">
                            <a href="#portfolioModal2" class="portfolio-link" data-toggle="modal">
                                ...
                                <img src="{{ asset('assets/img/portfolio/book.jpg') }}" class="img-responsive" alt="portfolio-image">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <div class="col-xs-6 col-sm-4 col-md-4 col-lg-2">
                            <a href="#" class="logo-link"><img src="{{ asset('assets/img/clients/envato-logo.png') }}" class="client-logo" alt="logo"></a>
                        </div>
                        <div class="col-xs-6 col-sm-4 col-md-4 col-lg-2">
                            <a href="#" class="logo-link"><img src="{{ asset('assets/img/clients/geforce-logo.png') }}" class="client-logo" alt="logo"></a>
                        </div>
                        <div class="col-xs-6 col-sm-4 col-md-4 col-lg-2">
                            <a href="#" class="logo-link"><img src="{{ asset('assets/img/clients/uber-logo.png') }}" class="client-logo" alt="logo"></a>
                        </div>
                        <div class="col-xs-6 col-sm-4 col-md-4 col-lg-2">
                    ...
                    <div class="item">
                        <div class="col-xs-6 col-sm-6 col-md-4 col-lg-2">
                            <a href="#" class="logo-link"><img src="{{ asset('assets/img/clients/woo-logo.png') }}" class="client-logo" alt="logo"></a>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-4 col-lg-2">
                            <a href="#" class="logo-link"><img src="{{ asset('assets/img/clients/valve-logo.png') }}" class="client-logo" alt="logo"></a>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-4 col-lg-2">
                            <a href="#" class="logo-link"><img src="{{ asset('assets/img/clients/talenthouse-logo.png') }}" class="client-logo" alt="logo"></a>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-4 col-lg-2">
                            <a href="#" class="logo-link"><img src="{{ asset('assets/img/clients/amazon-logo.png') }}" class="client-logo" alt="logo"></a>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-4 col-lg-2">
                            <a href="#" class="logo-link"><img src="{{ asset('assets/img/clients/river-logo.png') }}" class="client-logo" alt="logo"></a>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-4 col-lg-2">
                            <a href="#" class="logo-link"><img src="{{ asset('assets/img/clients/audio-logo.png') }}" class="client-logo" alt="logo"></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="carousel-inner">
                    <div class="carousel-inner">
                        <div class="item active">
                            <div class="col-md-6 col-sm-6">
                                <div class="block-text">
                                    <img src="{{ asset('assets/img/team/1.png') }}" alt="team-member-img3" class="col-md-6 img-circle">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="block-text">
                                    <img src="{{ asset('assets/img/team/2.png') }}" alt="team-member-img3" class="col-md-6 img-circle">
                                    <h5 class="testimonial-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </h5>
                        ...
                        <div class="item">
                            <div class="col-md-6 col-sm-6">
                                <div class="block-text">
                                    <img src="{{ asset('assets/img/team/4.png') }}" alt="team-member-img3" class="col-md-6 img-circle">
                                    <h5 class="testimonial-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </h5>
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="block-text">
                                    <img src="{{ asset('assets/img/team/3.png') }}" alt="team-member-img3" class="col-md-6 img-circle">
                                    <h5 class="testimonial-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. </h5>
        ...
        <div class="container-fluid wrapper">
            <div class="col-lg-12 footer-info">
                <a class="footer-logo" href="#header">
                    <img class="img-responsive" src="{{ asset('assets/img/footer-logo.png') }}" alt="logo-footer">
                </a>
    ...
    <script src="{{ asset('assets/js/settings-script.js') }}"></script>
    <!-- Plugin JavaScript -->
    ...
    <script src="{{ asset('assets/js/xBe.js') }}"></script>
